...
public enum Puzzles {
    public static let all: [Puzzle] = [
        ...
        Puzzle(
            ...
            candidates: [
                PuzzleCandidate(text: "Halden's CFO defended an 11-month payback to their board in March — I can walk you through their math, or we can build yours from your numbers. Which is more useful?", eval: 0.8, rationale: "A named peer with a specific number is hard to dismiss as vendor math, and the either/or hands the CFO the choice of method. They shift from evaluating your cost to evaluating the math — you're now solving their board problem with them.", atlasTags: ["social-proof", "calibrated-question"]),
        ...
        Puzzle(
            ...
            candidates: [
                ...
                PuzzleCandidate(text: "Let's set up a proper discovery session later.", eval: 0.2, rationale: "Acceptable, but you just parked the live moment. The function-specific drag was askable right now — and later has a way of becoming never.", atlasTags: ["calibrated-question"]),
            ],
            bestIndex: 0, themeHint: nil,
            transcriptId: "voss-haiti-how"
        ),
