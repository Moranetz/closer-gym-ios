    ...
    public static let all: [MasterGame] = [
        ...
        MasterGame(
            ...
            moves: [
                ...
                MasterMove(role: .op, text: "I'll do something better — I'll spend the first three minutes telling you the two reasons we'd be wrong for you. If at minute three you want me to keep going, I will. If not, we both save time.", techniqueIds: ["accusation-audit", "takeaway"], annotation: "Operator redefines who is qualifying whom. Recipient just imposed a time constraint to establish power posture; this move re-anchors the dynamic to fit-evaluation without contesting the time constraint itself.", delta: 0.68),
